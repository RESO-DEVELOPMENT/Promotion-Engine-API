    ...
    public class VoucherRepositoryImp : IVoucherRepository
    {
        ...
        public async Task InsertBulk(List<Voucher> vouchers)
        {
            try
            {
                ...
                {
                    PointifyContext context = null;
                    try
                    {
                        context = new PointifyContext(options: GetDbOption());
        ...
        private PointifyContext AddToContext(PointifyContext context,
            Voucher entity,
            int count,
            int commitCount,
        ...
        {
            using (var context = new PointifyContext())
            {
