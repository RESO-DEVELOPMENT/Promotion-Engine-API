            ...
            try
            {
                ...
                if (groups.Count > 0)
                {
                    foreach (var group in groups)
                    {
                        ...
                        else if (group.GiftNavigation != null)
                        {
                            dto.PostActionType = group.GiftNavigation.PostActionType;
        ...
        public async Task<VoucherGroupDetailDto> GetDetail(Guid id)
        {
            try
            {
                ...
                if (group != null)
                {
                    ...
                    if (group.GiftNavigation != null)
                    {
                        result.PostActionType = group.GiftNavigation.PostActionType;
                        result.Gift = group.GiftNavigation;
                    }
        ...
        private async Task UpdateTierOfVoucherGroup(VoucherGroup entity)
        {
            ...
            if (tiers.Count() > 0)
            {
                foreach (var tier in tiers)
                {
                    ...
                    {
                        tier.Gift = entity.GiftNavigation;
                    }
